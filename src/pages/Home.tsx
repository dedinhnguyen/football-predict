      ...
      <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 md:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => logout()}
              className="flex h-9 w-9 items-center justify-center rounded-lg border border-white/5 bg-white/5 text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition-all duration-200"
              title={t('logout')}
            >
                          ...
                          <div>
                            ...
                            <div className="flex gap-2">
                              {(match.handicap === 0 ? (['home', 'draw', 'away'] as const) : (['home', 'away'] as const)).map((choice) => {
                                ...
                                const isInteractive = !locked && !limitReached;
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-4 sticky left-12 bg-slate-900/90 z-10 border-r border-white/5 flex items-center gap-2">
                              ...
                              {isMe && (
                                <span className="text-[8px] bg-blue-500/20 text-blue-300 font-bold px-1 rounded uppercase tracking-wider">{t('meBadge')}</span>
                              )}
                            </td>
